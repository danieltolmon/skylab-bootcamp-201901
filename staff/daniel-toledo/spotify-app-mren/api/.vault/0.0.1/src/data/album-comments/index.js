...
const albumComment = {
    ...
    add(comment) {
        ...
        if (comment.constructor != Object) throw TypeError(`${comment} should be an Obect`)
    ...
    find(criteria) {
        ...
        if (criteria.constructor != Object) throw TypeError(`${criteria} should be an Obect`)
